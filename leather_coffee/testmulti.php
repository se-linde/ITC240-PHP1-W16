...
#EDIT THE FOLLOWING:
$toAddress = "spinifex@gmail.com";  //place your/your client's email address here
$toName = "WEB 120"; //place your client's name here
$website = "Spinifex Questionnaire";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Your comments are important to us! Or else!" tabindex="60"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
